...
const WellnessInsightsInputSchema = z.object({
  wellnessData: z.string().describe('A string containing the user wellness and activity data.'),
});
...
const prompt = ai.definePrompt({
  ...
  Analyze the following wellness and activity data to provide wellness insights, recommend low-cost alternatives, and generate a personalized wellness plan.
...
export const wellnessInsightsFlow = ai.defineFlow(
  {
